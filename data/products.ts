...
export const shoes: Shoe[] = [
...

  {
    ...
    brand: "LOTTO",
    name: "BAREFOOT NPS",
    subtitle: "The Barefoot Slip-Off",
    whyWeMadeIt: "We crush our heels down a dozen times a day, and most of us would rather feel the floor than be propped up off it. Neither is misuse — both are unwritten requirements no brand ever designed for.",
    purposeA: { label: "BAREFOOT, ALL DAY", description: "Thin flexible sole, wide forefoot, near-zero drop. You feel the ground instead of being held above it." },
    purposeB: { label: "GYM & LIFTING", description: "Flat, firm and low is exactly what you want under a squat or a deadlift. A stacked heel works against you." },
    purposeS: { label: "OFF IN THREE SECONDS", description: "Step on the heel and it folds flat, then springs back. On and off at every doorway, for years rather than weeks." },
    value: "The barefoot shoe, the lifting shoe, and the one you kick off at the door — in one pair that doesn't get thrown away.",
    features: "Ground Last's wider forefoot over a thin flexible sole; Fold Heel folds flat and springs back; Resole construction keeps it going; Fresh Lining stops smell worn sockless all day.",
  ...
  },
  {
    ...
    whyWeMadeIt: "Only a small fraction of people who own a skate shoe have ever skated in one. So we built the real thing, then named it after the way it actually gets worn.",
    purposeA: { label: "GENUINE SKATING", description: "Reinforced suede exactly where a skate shoe wears through first." },
    purposeB: { label: "CASUAL, EVERY DAY, EVERYONE", description: "Comfortable and unbothered in the New Balance sense — jeans, shorts or a kurta, on anyone from sixteen to sixty." },
    ...
    value: "A credible skate shoe that everybody can wear without thinking about it — one object, two lives.",
...
export const campaigns: Campaign[] = [
  ...
  },
  {
    ...
    gtm: "Parks are permanent and public. Dad Shoe becomes the shoe the local scene actually wears because we earned it.",
  },
  {
    id: "dry-by-morning",
    name: "DRY BY MORNING",
